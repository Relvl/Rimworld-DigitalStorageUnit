...
namespace ProjectRimFactory
{
    public static class PlaceThingUtility
    {
        ...
        public static bool CanPlaceThingInSlotGroup(Thing t, SlotGroup slotGroup, Map map)
        {
            ...
            Debug.Message(Debug.Flag.PlaceThing, "There were StorageBlockersIn every cell of " + slotGroup.parent + " - can not place" + t);
            return false;
        }
        ...
        static PlaceThingUtility()
        {
            ...
            var dm = new DynamicMethod(
                ...
                typeof(bool),
                new Type[] { typeof(IntVec3), typeof(Map), typeof(Thing) },
