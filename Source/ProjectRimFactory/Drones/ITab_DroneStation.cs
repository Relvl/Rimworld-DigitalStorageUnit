    ...
    public class ITab_DroneStation_Def : IPRF_SettingsContent
    {
        ...
        public Listing_Standard ITab_Settings_AppendContent(Listing_Standard list, Rect parrent_rect)
        {
            ...
            if (droneStation.compRefuelable != null)
            {
                ...
                rect = list.GetRect(30f);
                list.Gap();
                droneStation.compRefuelable.TargetFuelLevel = Widgets.HorizontalSlider_NewTemp(
                    rect,
                    droneStation.compRefuelable.TargetFuelLevel,
                    0,
                    droneStation.compRefuelable.Props.fuelCapacity,
                    true,
                    "SetTargetFuelLevel".Translate(droneStation.compRefuelable.TargetFuelLevel),
                    "0",
                    droneStation.compRefuelable.Props.fuelCapacity.ToString(),
                    1
                );
            }
