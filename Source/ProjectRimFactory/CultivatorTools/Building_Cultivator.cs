...
namespace ProjectRimFactory.CultivatorTools
{
    ...
    public class Building_Cultivator : Building_SquareCellIterator
    {
        ...
        {
            if (plantDef.blueprintDef != null &&
                (ProjectRimFactory_ModComponent.ModSupport_SeedsPlease || ProjectRimFactory_ModComponent.ModSupport_SeedsPleaseLite) &&
        ...
        protected void MakeMatchingGrowZone()
        {
            ...
            designator.DesignateMultiCell(from tempCell in iter.cellPattern let pos = tempCell + Position where designator.CanDesignateCell(pos).Accepted select pos);
        }
        ...
        public virtual void CreatePlantProducts(Plant p)
        {
            ...
            var PRF_StaticPawnPos = IntVec3.Invalid;
