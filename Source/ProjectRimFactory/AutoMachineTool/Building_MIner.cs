...
namespace ProjectRimFactory.AutoMachineTool
{
    public class Building_Miner : Building_BaseMachine<Building_Miner>, IBillGiver, IRecipeProductWorker, IXMLThingDescription, IBillTab
    {
        ...
        protected override bool FinishWorking(Building_Miner working, out List<Thing> products)
        {
            ...
            def.GetModExtension<ModExtension_ModifyProduct>()?.ProcessProducts(products, this as IBillGiver, this, workingBill.recipe);
    ...
    public static class RecipeRegister
    {
        static RecipeRegister()
        {
            ...
            if (minerDef != null)
            {
                ...
                var mineables = DefDatabase<ThingDef>.AllDefs.Where(d => d.mineable && d.building != null && d.building.mineableThing != null && d.building.mineableYield > 0)
                ...
                mineables.AddRange(
                    DefDatabase<ThingDef>.AllDefs.Where(d => d.deepCommonality > 0f && d.deepCountPerPortion > 0)
                ...
                var acceptableRecipeDefs = recipeDefs.FindAll(r => !minerDef.GetModExtension<ModExtension_Miner>()?.IsExcluded(r.products[0].thingDef) ?? true);
