...
namespace ProjectRimFactory
{
    ...
    public class GraphicExtraData
    {
        ...
        public static GraphicExtraData Extract(GraphicRequest req, out GraphicRequest outReq, bool removeExtraFromReq = false)
        {
            ...
            if (req.graphicData.texPath[0] == '[')
            {
                ...
                try
                {
                    ...
                    extraData = DirectXmlToObject.ObjectFromXml<GraphicExtraData>(helperDoc.DocumentElement, false);
                }
                catch (Exception e)
                {
                    Log.Error("GraphicExtraData was unable to extract XML from \"" + req.graphicData.texPath + "\"; Exception: " + e);
                    return null;
                }
        ...
        public override string ToString()
        {
            ...
            {
                pieces.Add(" specialLinkDefs: [" + String.Join(", ", specialLinkDefs) + "]");
            }
