...
using DigitalStorageUnit.Common; // for dynamic method
using Verse;
...
public static class PlaceThingUtility
{
    ...
    public static bool PRFTryPlaceThing(this IPRF_Building placer, Thing t, IntVec3 cell, Map map, bool forcePlace = false)
    {
    ...
    private static bool PlaceThingNextBuilding(this IPRF_Building placer, IPRF_Building nextBuilding, Thing t, IntVec3 cell, Map map)
    {
    ...
    private static bool PlaceThingInSlotGroup(this IPRF_Building placer, Thing t, SlotGroup slotGroup, IntVec3 cell, Map map)
    {
    ...
    ///   (or, you know, they pile stuff up until it falls, or use a machine arm to move things, etc)
    /// </summary>
    ...
    public static bool PlaceThingAnywhereInSlotGroup(this IPRF_Building placer, Thing t, SlotGroup slotGroup, IntVec3? cell = null)
    {
        ...
        Debug.Message(Debug.Flag.PlaceThing, "There were StorageBlockersIn every cell of " + slotGroup.parent + " - cannot place" + t);
        return false;
    }
    ...
    static PlaceThingUtility()
    {
        ...
        var dm = new DynamicMethod(
            "directly call RimWorld.StoreUtility's NoStorageBlockersIn",
            typeof(bool),
        ...
        il.Emit(OpCodes.Call, typeof(StoreUtility).GetMethod("NoStorageBlockersIn", BindingFlags.Static | BindingFlags.NonPublic));
        ...
        CallNoStorageBlockersIn = (Func<IntVec3, Map, Thing, bool>)dm.CreateDelegate(typeof(Func<,,,>).MakeGenericType(typeof(IntVec3), typeof(Map), typeof(Thing), typeof(bool)));
